...
\\\\
This project wants to help solving this problem, providing a visual comparison to explore differences and similarities between what users search and what airlines provides. Being able to compare between specific dates to guess user behavior.
\end{abstract}
