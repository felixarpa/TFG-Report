...
\thesistitle{Skyscanner Heatmap} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Francisco López} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\def \company{\href{https://www.skyscanner.net/}{SKYSCANNER}}
...
\vspace*{.04\textheight}
{\scshape\LARGE \company\\ in collaboration with\\ \univname\par}\vspace{1.5cm} % University name
\textsc{\Large Final Degree Project}\\[0.5cm] % Thesis type

\HRule \\[0.4cm] % Horizontal line
{\Huge \bfseries \ttitle\par}\vspace{0.4cm} % Thesis 
{\large Skyskanner's data domain representation\par}\vspace{0.1cm} % Thesis title
...
\\\\
Is the air industry as efficient as it could? Are all airplane users satisfied with their purchases and possibilities? \textit{Skyscanner} provides an easy to use tool to search cheap flights from any airport to another. Sadly, user does not always find what he/she wants, not because \textit{Skyscanner} does not provide all the information. Some routes between two airports do not exists, even people search for them a lot. Some flights are too busy and very expensive.
\\\\
This project wants to help solving this problem providing a heat map to explore differences and similarities between what users search, finds and actually buys and what airlines provides. Being able to compare between specific dates to guess user behavior; compare two airports or cities to invest in airports that are growing faster and have more future expectations, etc.
\end{abstract}
