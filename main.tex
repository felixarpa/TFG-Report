...
{\large Skyscanner's data domain representation\par}\vspace{0.1cm} % Thesis title
...
\\\\
Is the air industry as efficient as it could? Are all airplane users satisfied with their purchases and possibilities? \company\ provides an easy to use tool to search cheap flights from any airport to another. Sadly, user does not always find what he/she wants, not because \company\ does not provide all the information. Some routes between two airports do not exists, even people search for them a lot. Some flights are too busy and very expensive.
\\\\
