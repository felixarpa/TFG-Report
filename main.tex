...
\\\\
Is the air industry as efficient as it could? Are all airplane users satisfied with their purchases and possibilities? \company\ provides an easy to use tool to search cheap flights from any airport to another. Sadly, sometimes is difficult for users to find what they really want.
\\\\
This project wants to help solving this problem, providing a heat map to explore differences and similarities between what users search, finds and finally buys and what airlines provides. Being able to compare between specific dates to guess user behavior.
\end{abstract}
