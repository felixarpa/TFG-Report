...
\\\\
The Heatmap relies on the timetable of Single Flight Number service, also known as \nameref{timetable_sfn_service}. This service provides all the \textbf{current} flights. This is a little bit of a problem when trying to get past routes: Timetable SFN Service does not provide past flights information, it is always \textbf{up-to-date}. In order to get this data it is needed to go one step back in the whole DeLorean data processing: \nameref{timetable_pipeline}.
\\\\
...
\\\\
%Tech specifications of Timetable SFN Services will be explained in \ref{sfn_tech} \nameref{sfn_tech}
...
\\\\
%Tech specifications of Timetable Pipeline will be explained in \ref{pipeline_tech} \nameref{pipeline_tech}
