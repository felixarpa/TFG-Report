...
DeLorean\cite{delorean_squad_home} is a squad\footnote{Learn more about \textit{\nameref{appendix_a}} in Appendix A on page \pageref{appendix_a}} of \tribe, its mission is to provide the best data and services around the routes, timetables and modes of transportation to go from one point on Earth to another.
